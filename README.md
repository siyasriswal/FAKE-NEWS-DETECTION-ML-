...
Fake News Detection using Machine Learning is a Natural Language Processing (NLP) project that classifies news articles as Real or Fake using machine learning algorithms.
